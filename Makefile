run_app:
	...
	find pages_files -exec sed -i.bak 's|_dash-component-suites|okhudyakoff\\/_dash-component-suites|g' {} \;
	find pages_files -exec sed -i.bak 's|_dash-layout|okhudyakoff/_dash-layout.json|g' {} \;
	find pages_files -exec sed -i.bak 's|_dash-dependencies|okhudyakoff/_dash-dependencies.json|g' {} \;
	find pages_files -exec sed -i.bak 's|_reload-hash|okhudyakoff/_reload-hash|g' {} \;
	find pages_files -exec sed -i.bak 's|_dash-update-component|okhudyakoff/_dash-update-component|g' {} \;
	find pages_files -exec sed -i.bak 's|assets|okhudyakoff/assets|g' {} \;
